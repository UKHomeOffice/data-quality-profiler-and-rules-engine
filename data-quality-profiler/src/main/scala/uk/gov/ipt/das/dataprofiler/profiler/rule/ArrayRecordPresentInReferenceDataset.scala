...
case class ArrayRecordPresentInReferenceDataset(definitionName: String,
                                                arrayPath: String,
                                                valuePath: String,
  ...
  val referenceDataAsSet: Set[String] = referenceDataset.asSet  // get ref data AsSet before entering Map.
              ...
              values.find(fv => fv.flatPath == valuePath).map { fv =>
                ...
                FeaturePoint(
                  ...
                  feature = FeatureOutput(
                    feature = definition,
                    value = BooleanValue(referenceDataAsSet.contains(fv.recordValue.valueAsString)),// get ref data AsSet before entering Map.
                  ),
                  recordSet = recordSet,
